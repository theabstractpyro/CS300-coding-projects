...
public class Book
{
   ...
   * 
   * @return true if object o is a book and all attributes are the same
   */
  @Override
  public boolean equals(Object o)
  {
    // checks if o is a book
    if (o instanceof Book)
    {
      // if o is a book, then check if all the attributes are the same
      if (this.getAuthor().equals(((Book) o).getAuthor())
          && this.getTitle().equals(((Book) o).getTitle())
          && this.getPageCount() == ((Book) o).getPageCount() && this.ID == ((Book) o).ID)
      {
