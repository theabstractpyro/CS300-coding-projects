...
public enum AssignmentPlannerState
{
  MAIN_MENU
  {
    ...
    public AssignmentPlannerState runState(Scanner scanner, AssignmentQueue queue)
    {
      ...
      { // Show/peek highest priority assignment
        // TODO implement calling peek() method on queue.
        // Make sure to consider the case when queue is empty

        return MAIN_MENU;
      } else if (num == 3)
      { // Complete highest priority assignment
        // TODO implement calling dequeue() method on queue.
        // Make sure to consider the case when queue is empty

        return MAIN_MENU;
      } else if (num == 4)
      { // List all assignments
        // TODO print a string representation of queue
  ...
  ADD_ASSIGNMENT
  {
    ...
    public AssignmentPlannerState runState(Scanner scanner, AssignmentQueue queue)
    {
      ...
      try
      { // try to parse month, day of the month, and hour of the due date
        ...
        // TODO create a new assignment with the above parameters (name and due date)
